      ...
      <>
        ...
        <div id="contenitoreSfondoS" className="sfondoBianco sezioneS">
          <div className="sezione-singola">
            ...
            <p className="testoS">
              The Eyes & Ears logo is created around a square, a shape that
              feels simple, familiar, and its subtle reference to the form of a
              book. To bring the name to life, we added eyes and ears to
              visually reinforce the brand name, symbolizing observation,
              listening, and making the design both clear and memorable.
            </p>
          </div>
        </div>
